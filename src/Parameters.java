...
public class Parameters
{
    ...
    public static double POPULATION_FLOW_SCALE = 0.1;//scale of how many people move around
    ...
    public static double SUSCEPTIBLE_TO_EXPOSED = 0.003* Parameters.TEMPORAL_RESOLUTION;//per temporal resolution TODO Make indepent of temporal resolution
    ...
    public static double SUSCEPTIBLE_TO_EXPOSED_TRAVELERS = 0.05 * Parameters.TEMPORAL_RESOLUTION;//special for travellers
