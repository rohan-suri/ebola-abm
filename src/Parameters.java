...
{
    public static double SCALE = .1; //percentage of total population that agents will be created.  Maximimum of 1
    public static double POPULATION_FLOW_SCALE = 0.20;//scale of how many people move around
