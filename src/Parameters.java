...
public class Parameters
{
    ...
    public static double POPULATION_FLOW_SCALE = 3;//scale of how many people move around
    ...
    public static double MIN_POP_URBAN = 1000.45;//Minimum population density per 926 meters or 1000 people per square mile to be urban. Source: http://cber.cba.ua.edu/asdc/urban_rural.html
    public static double MIN_POP_SURROUNDING = 1000.73;//Minimum surrounding population density per 926 meters.  An urban district must be surrounded by
    ...
    public static double SUSCEPTIBLE_TO_EXPOSED = 0.007 * Parameters.TEMPORAL_RESOLUTION;//per temporal resolution TODO Make indepent of temporal resolution
    ...
    public static double SUSCEPTIBLE_TO_EXPOSED_TRAVELERS = 0.4 * Parameters.TEMPORAL_RESOLUTION;//special for travellers
